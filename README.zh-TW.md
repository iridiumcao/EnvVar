...
由於本專案是全新的開源軟體，且尚未申請程式碼簽章憑證，Windows SmartScreen 可能會跳出以下警告：

- `Windows 已保護您的電腦`
- `Microsoft Defender SmartScreen 封鎖了無法識別的應用程式啟動`

解決方式：點擊 **仍要執行** 即可繼續安裝。

本軟體完全開源、無病毒，您也可以自行查看原始碼驗證。
...
8. 透過「檔案」選單進行匯出 / 匯入。
9. 透過「偏好設定」選單切換語言、主題、顯示別名欄、最大歷史記錄和日誌，選擇會自動記住。
